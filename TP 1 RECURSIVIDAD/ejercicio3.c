...
// funcion que calcula a partir de un numero entero el nivel de la serie de fibonacci
int terminoSerieFibonacci (int k) {
    if (k <= 0) return 1; // caso base
    else if (k == 1) return 1; // caso base
...
int main() {
    int num;
    printf("Ingrese un numero entero positivo (se tomara 0 con input vacio que imprime 0) (maximo 40): ");
