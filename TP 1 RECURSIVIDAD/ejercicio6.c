...
// funcion auxiliar recursiva para concatenar la cantidad de chinos indicada por el parametro nivel a la cadena chinos, utilizando como base la cadena chino
