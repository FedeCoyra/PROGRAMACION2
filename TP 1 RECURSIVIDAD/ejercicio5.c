...
char * agregarSeparadorMiles(char numero[]) {
    ...
    memset(cRetorno, 0, 150); // inicializo la cadenaRetorno, IMPORTANTE
    ...
    return c;
    // No debe devolver la direccion de la variable de la pila directamente, ya que
    // se destruye una vez que se elimina el marco de la pila
    // (despues de que regresa la funcion)
}
