...
Cola llenar_cola_al_azar() {
    ...
    for (int i = 0; i < tamano; i++) {
        ...
        if (!l_agregar(listaAux, elemento)) {
            printf("No se pudo agregar el elemento debido a que la estructura esta llena (lista).\n");
            printf("Se dejaran de agregar elementos y se trabajara con la lista actual.\n");
            break;
        }
        if (!c_encolar(cola, elemento)) {
            printf("No se pudo agregar el elemento debido a que la estructura esta llena (cola).\n");
...
Pila llenar_pila_al_azar() {
    ...
    for (int i = 0; i < tamano; i++) {
        ...
        if (!p_apilar(pila, elemento)) {
            printf("No se pudo agregar el elemento debido a que la estructura esta llena (pila).\n");
            printf("Se dejaran de agregar elementos y se trabajara con la pila actual.\n");
            break;
        }
    }
    return pila;
