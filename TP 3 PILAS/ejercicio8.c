...
Pila rellenar_pila_por_teclado() {
    Pila pila = p_crear();
    int longitudPila = 0;
    printf("Ingrese la longitud de la pila (maximo %d elementos). ", TAMANIO_MAXIMO);
    longitudPila = leer_entero();
    while (longitudPila > TAMANIO_MAXIMO || longitudPila <= 0) {
        printf("Error. Ingrese la longitud de la pila nuevamente. ");
        longitudPila = leer_entero();
    }
